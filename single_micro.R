...
mcc1_p <- expression((3*(p11+p22+p33)-1)/(2))
...
tMCC1<-((3*(p11+p22+p33)-1)/2) ## true value of MCC
...
res<-cbind(res,time)
#write.csv(res,file = "D:/study/MCC/R code/excel/s1_micro.csv")